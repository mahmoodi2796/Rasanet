...
function Footer() {
  return (
    <div className="w-full h-[400px]   relative mt-[200px]">
      <div>
        <svg
      ...
      <div className="w-full h-[290px] mx-auto container flex justify-between items-start mt-[0px] md:mt-[110px] px-[15px] md:px-[0px]">
